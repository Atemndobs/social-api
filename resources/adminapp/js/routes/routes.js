...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'follows',
        name: 'follows.index',
        component: () => import('@cruds/Follows/Index.vue'),
        meta: { title: 'cruds.follow.title' }
      },
      {
        path: 'follows/create',
        name: 'follows.create',
        component: () => import('@cruds/Follows/Create.vue'),
        meta: { title: 'cruds.follow.title' }
      },
      {
        path: 'follows/:id',
        name: 'follows.show',
        component: () => import('@cruds/Follows/Show.vue'),
        meta: { title: 'cruds.follow.title' }
      },
      {
        path: 'follows/:id/edit',
        name: 'follows.edit',
        component: () => import('@cruds/Follows/Edit.vue'),
        meta: { title: 'cruds.follow.title' }
      }
    ]
  }
